...
public class Tarea1 {
    ...
    static void menu(){
        ...
        System.out.println("1. Conversor de medidas");
        System.out.println("2. Serie Fibonacci");
        System.out.println("3. Vector");
        System.out.println("4. Triangulo de Pascal");
        System.out.println("5. Cadena 1");
        System.out.println("6. Cadena 2");
        System.out.println("7. Numero aleatorio");
        System.out.println("8. Sumtoria");
        System.out.println("9. Matrices");
        System.out.println("10. Arreglos");
        ...
        switch(op){
            ...
            case 12:
                System.out.println("Y GRACIAS POR VENIR, GRACIAS POR VENIR");
            break;
